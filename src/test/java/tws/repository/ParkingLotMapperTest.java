...
public class ParkingLotMapperTest {
    ...
    public void shouldFetchAllParkingLots() {
        ...
        // when
        List<ParkingLot> parkingLotsList = parkingLotMapper.selectAllParkingLots();
        // then
    ...
    public void shouldGetParkingLotWhenCallInsertParkingLot() {
        // given
    	parkingLotMapper.insertParkingLot(new ParkingLot(1, 10, 10));
        // when
        List<ParkingLot> parkingLotsList = parkingLotMapper.selectAllParkingLots();
        // then
        assertEquals(1, parkingLotsList.get(0).getPrakingLotId());
        assertEquals(10, parkingLotsList.get(0).getCapacity());
